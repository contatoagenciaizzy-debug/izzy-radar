...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "opensquad Dashboard — Agência Izzy" },
      { name: "description", content: "Painel em tempo real dos squads de agentes de IA da Agência Izzy." },
      { property: "og:title", content: "opensquad Dashboard — Agência Izzy" },
